...
export default class Droplets extends BaseModule {
     ...
     * @returns Promise
     */
    create(options: CreateSingleDropletsRequest): Promise<CreateSingleDropletResponse>;
    createMultiple(options: CreateMultipleDropletsRequest): Promise<CreateMultipleDropletsResponse>;
    /**
